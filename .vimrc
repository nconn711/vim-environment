...
" Set syntax for verilog/systemverilog files explicitly
...
" Ignore files in Vim file explorer with Regex expressions
let g:netrw_list_hide = '\.o$,^\./$'
let g:netrw_hide = 1

" Fix weird background color erase
let &t_ut=''

" Sets how many lines of history VIM has to remember
set history=500

" Set tag location / will search curr directory all the way up to root
set nocst
set tags=./tags;

" Change directory to whatever file was opened in vim
set autochdir
...
" => Text, tab and indent related
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Autocomplete bracket after enter
...
" Get out of insert mode with j+k
inoremap jk <Esc>

" Cap y copies to clipboard
noremap Y "+y
...
if has("autocmd")
    autocmd BufWritePost * :call CleanExtraSpaces()
endif
